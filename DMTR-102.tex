...
service at the LDF\\
This test activity demonstrates the successful execution of the services
for storing of raw image files from the DAQ to the DBB and then
visualized through the LSST science platform (LSP). ~ This is at a very
small scale and it's purpose is to test the components or (POC proof of
concept) that they all work together. ~\\[2\baselineskip]It will
demonstrate
...
\item
  ...
  metadata about the image and provenance. ~
\item
